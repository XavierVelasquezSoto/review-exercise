...
/* 
const vowel = letters => {
   let fixedLetters = letters.charAt(1) + letters.charAt(3) + letters.charAt(4)
...
const vowel = letters => {
    ...
    if(letters.charAt(0)=== "a" || letters.charAt(0)=== "e" || letters.charAt(0)=== "i" || letters.charAt(0)=== "o" || letters.charAt(0)=== "u"){
        fixedLetters += letters.charAt(0)
    }
    if(letters.charAt(1)=== "a" || letters.charAt(1)=== "e" || letters.charAt(1)=== "i" || letters.charAt(1)=== "o" || letters.charAt(1)=== "u"){
        fixedLetters += letters.charAt(1)
    }
    if(letters.charAt(2)=== "a" || letters.charAt(2)=== "e" || letters.charAt(2)=== "i" || letters.charAt(2)=== "o" || letters.charAt(2)=== "u"){
        fixedLetters += letters.charAt(2)
    }
    if(letters.charAt(3)=== "a" || letters.charAt(3)=== "e" || letters.charAt(3)=== "i" || letters.charAt(3)=== "o" || letters.charAt(3)=== "u"){
        fixedLetters += letters.charAt(3)
    }
    if(letters.charAt(4)=== "a" || letters.charAt(4)=== "e" || letters.charAt(4)=== "i" || letters.charAt(4)=== "o" || letters.charAt(4)=== "u"){
